...
define('LNG_UpgradeMeLK', ' (<a href="http://www.interspire.com/emailmarketer/" target="_blank">Upgrade</a>)');
define('LNG_ApplicationTitleEdition', ' (%s Edition)');
define('LNG_SendingSystem', LNG_ApplicationTitle);
define('LNG_UrlPF_Intro', 'You\'re currently running a free trial of '.LNG_ApplicationTitle.'.%sYou\'re on day %s of your %s day free trial. <a href="http://www.interspire.com/emailmarketer/pricing.php" target="_blank">Click here to learn about upgrading</a>.');
define('LNG_UrlPF_ExtraIntro', ' During the trial, you can send up to %s emails. ');
define('LNG_UrlPF_Intro_Done', 'You\'re currently running a free trial of '.LNG_ApplicationTitle.'.%sYour license key expired %s days ago. <a href="http://www.interspire.com/emailmarketer/pricing.php" target="_blank">Click here to learn about upgrading</a>.');
define('LNG_UrlP', '');
		...
		<tr align="center">
			<td>
				<table bgcolor="white" width="450" border="0" cellpadding="5">
					<tr>
						<td>
							<a href="http://www.interspire.com/emailmarketer/?campaign_email">
 ...
 **************************
 */
defined('LNG_Copyright') or define('LNG_Copyright', 'Powered by <a href="http://www.interspire.com/emailmarketer/" target="_new">Interspire Email Marketer ' . IEM::VERSION . '</a> &copy; Interspire Pty. Ltd.');
