...
defined('LNG_ApplicationTitle') or define('LNG_ApplicationTitle', 'Hairyspire Email Marketer');
...
define('LNG_SMTPCOM_Explain', '
	<a href="http://smtp.com/" target="_blank" border="0"><img src="images/smtp_com_logo.gif" border="0" /></a>
	...
	<div>
		...
		<ol style="line-height:1.5">
			<li><a href="http://smtp.com/" target="_blank">Sign up for an SMTP.com account here</a></li>
...
define('LNG_Index_LatestNewsURL', 'http://anonym.to/?http://www.interspire.com/content/blogrss.php');
define('LNG_PopularHelpArticles', 'Popular Help Articles');
define('LNG_Index_PopularArticlesURL', 'http://anonym.to/?http://www.viewkb.com/rss.php?c=138&t=popular');
define('LNG_UpgradeNoticeInfo', '
	...
	<p style="text-align: left;"><a target="_blank" href="http://anonym.to/?http://www.interspire.com/emailmarketer/"><img border="0" alt="" src="images/learnMore.gif"/></a></p>
');
			...
			<td>
				<table bgcolor="white" width="450" border="0" cellpadding="5">
					<tr>
						<td>
							<a href="#">
								<img border="0" src="' . SENDSTUDIO_APPLICATION_URL . '/admin/images/poweredby.gif" alt="Powered by Hairyspire" />
							</a>
						</td>
					</tr>
				</table>
...
define('LNG_Form_Branding', '<span style="display: block; font-size: 10px; color: gray; padding-top: 5px;"><a href="#" target="__blank" style="font-size:10px;color:gray;">Email marketing</a> by Hairyspire</span>');
...
define('LNG_Home_Video_Link','http://anonym.to/?http://static.interspire.com/iem-quick-tour/index.html');
define('LNG_Home_Getting_Starting_Link','http://anonym.to/?http://www.interspire.com/emailmarketer/pdf/InterspireEmailMarketerUserGuide.pdf');
 ...
 **************************
 */
defined('LNG_Copyright') or define('LNG_Copyright', 'Powered by <a href="" target="_new">Hairyspire Email Marketer ' . IEM::VERSION . '</a> &copy; Hairyspire Ltd.');
