...
<table style="margin-top:0px;" border="0" cellspacing="0" cellpadding="0" width="100%" class="Text GroupMtas" >
				                				<tr  class="GridRow">
			                						...
			                						{template="group_mtas_advanced_options"}
			                						</td>
			                					</tr>
			                					<tr  class="GridRow">
			                					...
			                					<tr  class="GridRow GridRowWhite">
			                						<td class="mta_group_mail_settings">
			                						<input class="btn btn-success" onclick="mta_details_do('save','{$item.uid}',this);return false;" type="button" value="%%LNG_Save%%">
			                						<input class="btn" onclick="mta_details_do('test','{$item.uid}',this);return false;" type="button" value="%%LNG_TestSMTPSettings%%">
			                						</td>
			                					</tr>
	                						</table>
</div>
