...
<input type="hidden" name="mta_group_uid" value="{$value.mta_group_uid}">
	<table cellspacing="0" cellpadding="0" width="100%" align="center">
		...
		<tr>
			<td>
				<input class="FormButton SubmitButton btn" type="submit" value="%%LNG_Save%%">
				<input class="FormButton CancelButton btn" type="button" value="%%LNG_Cancel%%" onclick="javascript: document.location='index.php?Page=Addons&Addon=mta&Action=manager';" />
				<br />&nbsp;
				...
				<table width="100%" cellspacing="0" cellpadding="2" border="0" class="PanelPlain">
					<tr>
						...
						<td valign="top" height="30">
							<input class="FormButton SubmitButton btn btn-success" type="submit" value="%%LNG_Save%%" />
							<input onclick="javascript: document.location='index.php?Page=Addons&Addon=mta&Action=manager';" class="FormButton CancelButton btn" type="button" value="%%LNG_Cancel%%" />
						</td>
					</tr>
				</table>
			</td>
