				...
				<table width="100%" cellspacing="0" cellpadding="2" border="0" class="PanelPlain">
					<tr>
						...
						<td valign="top" height="30">
							...
							<input type="submit" name="test_smtp" value="%%LNG_TestSMTPSettings%%" class="FormButton btn btn-warning" style="width: 120px;" />
							<input onclick="javascript: document.location='index.php?Page=Addons&Addon=mta&Action=group&id={$group.mta_group_uid}';" class="FormButton CancelButton btn" type="button" value="%%LNG_Cancel%%" />
						</td>
					</tr>
				</table>
			</td>
