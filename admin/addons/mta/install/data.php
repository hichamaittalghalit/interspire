...
#END_BLOCK_2B#
#START_BLOCK_3A#
if (isset($GLOBALS['addon_mta_class'])) {
    $GLOBALS['addon_mta_class']->iem_switch_smtp($this,$disconnect);
}
else
{
    $addon_system = new Interspire_Addons();
...
#START_BLOCK_5A#
if (isset($GLOBALS['addon_mta_class'])) {
    $GLOBALS['addon_mta_class']->iem_log_send_pre($this,$send_results);
}
#END_BLOCK_5A#
#START_BLOCK_5B#
if (isset($GLOBALS['addon_mta_class'])) {
    $GLOBALS['addon_mta_class']->iem_log_send($this,$send_results);
}
#END_BLOCK_5B#
#START_BLOCK_5C#
if (isset($GLOBALS['addon_mta_class'])) {
    $GLOBALS['addon_mta_class']->iem_log_send($this,$send_results,true);
}
#END_BLOCK_5C#
#START_BLOCK_6A#
$addon_system = new Interspire_Addons();
